                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              @can('delete',$item)
                              <form action="{{route('anggota.destroy',$item['nama_petugas'])}}" method="post" style="display: inline">
                                @method('DELETE')
                                @csrf
                              ...
                              @endcan
                              @can('update',$item)
                              {{-- <a href="{{rouste('anggota.edit',$item["nama_anggota"])}}" class="btn btn-sm btn-rounded btn-warning">ubah</a> --}}
                              @endcan  
                            </td>
                        </tr>
                         @endforeach
